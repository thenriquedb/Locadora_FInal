...
${OBJECTDIR}/GUI_nomain.o: ${OBJECTDIR}/GUI.o GUI.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GUI_nomain.o GUI.c;\
	else  \
...
${OBJECTDIR}/administracao_nomain.o: ${OBJECTDIR}/administracao.o administracao.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/administracao_nomain.o administracao.c;\
	else  \
...
${OBJECTDIR}/alocacao_nomain.o: ${OBJECTDIR}/alocacao.o alocacao.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/alocacao_nomain.o alocacao.c;\
	else  \
...
${OBJECTDIR}/cadastros_nomain.o: ${OBJECTDIR}/cadastros.o cadastros.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cadastros_nomain.o cadastros.c;\
	else  \
...
${OBJECTDIR}/edicaoDados_nomain.o: ${OBJECTDIR}/edicaoDados.o edicaoDados.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/edicaoDados_nomain.o edicaoDados.c;\
	else  \
...
${OBJECTDIR}/excluirDados_nomain.o: ${OBJECTDIR}/excluirDados.o excluirDados.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/excluirDados_nomain.o excluirDados.c;\
	else  \
...
${OBJECTDIR}/filtrosRelatorios_nomain.o: ${OBJECTDIR}/filtrosRelatorios.o filtrosRelatorios.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/filtrosRelatorios_nomain.o filtrosRelatorios.c;\
	else  \
...
${OBJECTDIR}/menus_nomain.o: ${OBJECTDIR}/menus.o menus.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/menus_nomain.o menus.c;\
	else  \
...
${OBJECTDIR}/verificacaoDeDados_nomain.o: ${OBJECTDIR}/verificacaoDeDados.o verificacaoDeDados.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/verificacaoDeDados_nomain.o verificacaoDeDados.c;\
	else  \
